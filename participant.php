  ...
  <div class="">
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
      <a class="navbar-brand p-0" href="#">
        <img src="./assets/images/Tcoe_logo.jpg" class="logo ms-5 p-0" alt="" />
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#prize-money">Prize Money</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#contact">Contact Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="modal" data-bs-target="#authModal" href="#login">Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="modal" data-bs-target="#authModal" href="#register">Register</a>
          </li>
        </ul>
      </div>
    </nav>
    <!-- Offcanvas Menu for Mobile -->
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="offcanvasMenu">
    ...
    <header class="hero bg-white text-center">
      <div class="container">
        <img src="./assets/images/Main Banner.png" alt="" width="100%" height="auto" />
      </div>
    </header>
    <!-- About Us Section -->
    <section id="about" class="about-section">
      <div class="container">
        ...
        <img src="./assets/images/About Us.png" alt="" class="" width="100%" height="auto" />
      </div>
    </section>
    <!-- Problem Statements Section -->
    <section id="problem-statements" class="bg-light">
      <div class="container">
        <div class="text-center">
          <h2 class="section-heading mb-4">Problem Statements</h2>
        </div>
        <div id="problemStatementsCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="row">
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/suo_moto.png" class="card-img-top" alt="5G Enabled Devices" />
                    <div class="card-body p-4">
                      <h5 class="card-title p-2">Suo Moto</h5>
                ...
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/ai_driven.png" class="card-img-top" alt="5G Enabled Devices" />
                    <div class="card-body p-4">
                      <h5 class="card-title p-2">
                        Applications: AI-Driven Network Maintenance
                      </h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#applyModal">
                        Apply Now
                      </button>
                ...
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/multi_model.png" class="card-img-top" alt="Advanced Drones" />
                    <div class="card-body">
                      <h5 class="card-title">
                        Applications: Multi-Modal Interactive System
                      </h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#applyModal">
                        Apply Now
                      </button>
            ...
            <div class="carousel-item">
              <div class="row">
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/5g_kiosk.jpg" class="card-img-top" alt="Application 4" />
                    <div class="card-body">
                      <h5 class="card-title">Applications:5G Kiosk</h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#applyModal">
                        Apply Now
                      </button>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/5g_enabled.png" class="card-img-top" alt="Application 5" />
                    <div class="card-body">
                      <h5 class="card-title">
                        Applications: 5G Enabled Consoles/Devices For Students
                      </h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#applyModal">
                        Apply Now
                      </button>
                ...
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/realtime_control.png" class="card-img-top" alt="Application 6" />
                    <div class="card-body">
                      <h5 class="card-title">
                        Applications: Real Time Control Of Advanced Drones
                      </h5>
                      <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#applyModal">
                        Apply Now
                      </button>
            ...
            <div class="carousel-item">
              <div class="row">
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/digital_twin.png" class="card-img-top" alt="Application 7" />
                    <div class="card-body">
                ...
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/ntn.png" class="card-img-top" alt="Application 8" />
                    <div class="card-body p-4">
                      <h5 class="card-title">
                ...
                <div class="col-md-4">
                  <div class="card">
                    <img src="./assets/images/5g_broadcast.png" class="card-img-top" alt="Application 9" />
                    <div class="card-body p-4">
          ...
          <button class="carousel-control-prev" type="button" data-bs-target="#problemStatementsCarousel"
            data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
          </button>
          <button class="carousel-control-next" type="button" data-bs-target="#problemStatementsCarousel"
            data-bs-slide="next">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="max-height: 70vh; overflow-y: auto">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#authModal">
                I Agree
              </button>
            </div>
          </div>
            ...
            <div class="tab-content" id="authTabContent">
              ...
              <div class="tab-pane fade" id="register" role="tabpanel">
                <form action="registration.php" method="post">
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Name" id="fullname" name="fullname" required />
                  </div>
                  <div class="mb-3">
                    <input type="email" class="form-control" placeholder="Email" id="email" name="email" required />
                  </div>
                  ...
                  <div class="mb-3">
                    <select class="form-select" id="categoryType" name="categoryType" required>
                      ...
                      <option value="Startup Professional">Startup Professional</option>
                    </select>
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Company Name" id="categoryName"
    ...
    <!-- Timelines Section -->
    <section id="timelines" class="bg-light">
      <div class="container text-center">
        <h2 class="section-heading mb-4">Timelines</h2>
        <img src="./assets/images/Timelines Banner.png" alt="" class="p-4" width="100%" height="auto" />
      </div>
    </section>
    <!-- Mentors Section -->
    <section id="mentors">
          ...
          <div class="carousel-inner">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_Neil.png" class="mentor-img" alt="Neil Shah" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Neil Shah</h3>
                      <p class="mentor-role">Counter Point Research</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_Ravi_Sina.png" class="mentor-img" alt="Ravi Sinha" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Ravi Sinha</h3>
                      <p class="mentor-role">O-Ran Alliance</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_Aayush.png" class="mentor-img" alt="Aayush Bhatnagar" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Aayush Bhatnagar</h3>
                      <p class="mentor-role">Jio</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="carousel-item">
              <div class="row">
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_mentor.png" class="mentor-img" alt="Sanjay Kumar" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Sanjay Kumar</h3>
                      <p class="mentor-role">TelcoLearn</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_gopi.png" class="mentor-img" alt="Gopi Krishna Lakkepuram" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Gopi Krishna Lakkepuram</h3>
                      <p class="mentor-role">Hyperleap AI</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_kiran.png" class="mentor-img" alt="Kiran Babu" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Kiran Babu</h3>
                      <p class="mentor-role">Rava AI</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="carousel-item">
              <div class="row">
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_rajan.png" class="mentor-img" alt="Ranjan Relan" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Ranjan Relan</h3>
                      <p class="mentor-role">AgentAnalytics.AI</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_pushkar.png" class="mentor-img" alt="Pushkar Apte" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Pushkar Apte</h3>
                      <p class="mentor-role">Qualcomm India Pvt. Ltd.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mentor-card">
                    <img src="./assets/mentors/medium_rajesh.png" class="mentor-img" alt="Rajesh Kumar Pathak" />
                    <div class="mentor-info">
                      <h3 class="mentor-name">Rajesh Kumar Pathak</h3>
                      <p class="mentor-role">Bharat 6G Alliance</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section id="faqs" class="bg-light">
      <div class="container text-center">
        ...
        <img src="./assets/images/FAQs.png" alt="" class="p-4" width="100%" height="auto" />
    ...
    <!-- Prize Money Section -->
    <section id="prize-money" class="">
      <div class="container text-center">
        <h2 class="section-heading text-center mb-4">PRIZE MONEY</h2>
        <!-- Cards Container -->
        <div class="row g-4">
          <!-- Row 1 -->
          <div class="col-md-4">
            <div class="card border-0 shadow-sm">
              <div class="card-body">
                <h5 class="card-title">First Prize</h5>
                <p class="card-text">2 Lakhs</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card border-0 shadow-sm">
              <div class="card-body">
                <h5 class="card-title">Second Prize</h5>
                <p class="card-text">1.5 Lakhs</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card border-0 shadow-sm">
              <div class="card-body">
                <h5 class="card-title">Third Prize</h5>
                <p class="card-text">1 Lakhs</p>
              </div>
            </div>
          </div>
          <!-- Row 2 -->
          <div class="col-md-4">
            <div class="card border-0 shadow-sm">
              <div class="card-body">
                <h5 class="card-title">Consolation Prize</h5>
                <p class="card-text">75K</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card border-0 shadow-sm">
              <div class="card-body">
                <h5 class="card-title">Best Idea Award</h5>
